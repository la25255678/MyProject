...
if(mysql_query("insert into myanmar_order(prod_no,prince,name,phone,address,order_no) values('$prod_no','$prince','$name','$phone','$address','$ordno')"))
{
...
<body>
    ...
    <center>
        ...
        <?php
        	include("connection.php");
			$sel=mysql_query("select * from  myanamr where image='$i' ");
