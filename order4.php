...
if(mysql_query("insert into singapore_order(prod_no,prince,name,phone,address,order_no) values('$prod_no','$prince','$name','$phone','$address','$ordno')"))
{
...
<body>
    ...
    <!--/.header-->
    	...
    	<div id="tooplate_content" class="left">
          <div id="comment_form">
		  <center>
            <h3>Singapore form</h3>
        <?php
        include("connection.php");
         $sel=mysql_query("select * from singapore  where image='$i' ");
