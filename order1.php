...
if(mysql_query("insert into china_order(prod_no,prince,name,phone,address,order_no) values('$prod_no','$prince','$name','$phone','$address','$ordno')"))
{
...
<body>
    ...
    <!--/.header-->
        ...
        <?php
        	include("connection.php");
			$sel=mysql_query("select * from china  where image='$i' ");
